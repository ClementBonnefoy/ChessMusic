...
public enum ESquare {
	...
	public static ESquare getSquare(File file, Rank rank) {
		return ESquare.values()[(rank.ordinal() << 3) + file.ordinal()];
	}

	public static ESquare getSquare(String notation) {
		if (notation.length() != 2)
			throw new IllegalArgumentException("This notation don't fit with any square : "+notation);

		return ESquare.getSquare(File.getFile(notation.charAt(0)), Rank.getRank(notation.charAt(1)));
	}
	...
	public ESquare nextSquare(Direction dir) {
